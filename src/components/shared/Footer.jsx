...
//         src={Logo}
//         alt="LITFEST"
//         style={{ maxWidth: "8rem", paddingBottom: "20px", cursor: "pointer" }}
//       />
//     </Link>
  ...
  return (
    <Box
      ...
      sx={{
        background: "#000000",
        backgroundImage:
          "linear-gradient(90deg, rgba(0, 6, 1, 1) 0%, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 1) 68%, rgb(5 31 37) 100%)",
        py: 6,
        px: 4,
        boxShadow:
          "rgba(50, 50, 93, 0.25) 0px 30px 60px -12px inset, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px inset",
    ...
    >
      <Stack direction={{ sm: "row", xs: "column" }} justifyContent={"center"} spacing={2}>
        <Stack spacing={4} width={"100%"} justifyContent={"center"}>
          <Stack direction={{ sm: "row", xs: "column" }} justifyContent={"center"} alignItems={"center"}>
            <Link to="/">
              <img
                src={Logo}
                alt="LITFEST"
            ...
            <Stack justifyContent={"center"} alignItems={"center"}>
              <Typography variant="h3" fontFamily="comfortaa,cursive" color="white">
                LITFEST
              </Typography>
              <Typography variant="subtitle1" color={"#00b2df"} textAlign={"center"} fontFamily="comfortaa,cursive">
                WORDS. WINTER. WONDER.
          ...
          <Stack justifyContent={"center"} alignItems={"center"} direction={{ sm: "row", xs: "column" }} spacing={3}>
            <Stack spacing={1} justifyContent={"center"} alignItems={"center"}>
              <Typography variant="h5" fontWeight={"bold"} fontFamily="comfortaa,cursive" color="white">
                Links
              </Typography>
              <Stack direction={"row"} spacing={2}>
                <Link to="/sumun" style={{ color: "#00b2df" }}>SUMUN</Link>
                <Link to="/sabdatattva" style={{ color: "#00b2df" }}>Sabdatattva</Link>
                <a href="https://linktr.ee/litfest_2025" target="_blank"style={{ color: "#00b2df" }}>Register</a>
              </Stack>
            </Stack>
            <Stack spacing={1}>
              <Typography variant="h5" fontWeight={"bold"} fontFamily="comfortaa,cursive" color="white">
          ...
          <Stack justifyContent={"center"} alignItems={"center"}>
            ...
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3721.8984460458894!2d85.8198186750407!3d20.29605831126732!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a19091846e4db1b%3A0x4a9e345c789d77f0!2sSilicon%20University%2C%20Silicon%20Hills%2C%20near%20DLF%20Cybercity!5e0!3m2!1sen!2sin!4v1708952981234!5m2!1sen!2sin"
            ></iframe>
          </Stack>
        </Stack>
      </Stack>
      ...
      <div className={styles.copy}>
        <p>&copy; Copyright 2025 LITFEST.</p>
      </div>
    </Box>
  );
}
